% Integrated section adapted from the independently compiled ChatGPT-authored note.
% The standalone source remains paper/mersenne_super_wieferich_depth_2026.tex.
...
The lemmas of Murty and S\'eguin classify prime powers in cyclotomic values
\cite[Lemmas~4.2--4.3]{MurtySeguin2019}.  At the unique exact-order index
they correspond to Wieferich and super-Wieferich primes.  Their results do not give a
