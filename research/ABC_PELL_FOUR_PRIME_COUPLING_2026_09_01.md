...
(4.2).  Squarefullness excludes the exceptional index `ell=7`, because
`A_7=239` is prime while `B_7=13^2`, so `u_7=A_7B_7` has valuation one at
`239`.  The nonemptiness of both odd-exponent sets now follows from the
