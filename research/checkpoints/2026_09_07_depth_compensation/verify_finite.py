#!/usr/bin/env python3
"""Replay two exact finite supplements; no asymptotic or existence inference."""
...
CASES = [
    ('2026_09_07_adversarial_audit/tenth_round', 'replay_three_arm_depth.py',
     'three_arm_depth_results.json', ['replay_three_arm_depth.py'], 'sha256'),
    ('2026_09_07_critical_bottleneck/tenth_round', 'replay_elementary_block.py',
     'elementary_block_replay.json', ['replay_elementary_block.py'], 'file_sha256'),
]
