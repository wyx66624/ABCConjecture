#!/usr/bin/env python3
"""Fresh, scoped Std-only compilation of reciprocal-depth arithmetic."""
...
MODULES = {
    ...
    'ReciprocalDepthArithmetic': '2026_09_07_critical_bottleneck/tenth_round',
}
NEW_MODULES = {'ReciprocalDepthArithmetic'}
...
def main():
    ...
    build = Path(tempfile.mkdtemp(prefix='depth-compensation-fresh-', dir=scratch))
    ...
    (build / 'lakefile.toml').write_text(
        'name = "ABCDepthCompensationAudit"\nversion = "0.1.0"\n'
        'defaultTargets = ["DepthCompensationAudit"]\n[leanOptions]\nwarningAsError = true\n'
        '[[lean_lib]]\nname = "DepthCompensationAudit"\nroots = [' + roots + ']\n')
    inventory = {}
    ...
    result = {
        ...
        'not_claimed': ['ABC proof or disproof', 'full repository build',
                        ...
                        'complete tenth-round formalization', 'Eisenstein UFD',
