...
SOURCES = {
    ...
    'JointPhasePackets': ('2026_09_07_joint_packets_and_jacobians', True),
    'QuotientCurveArithmetic': ('2026_09_07_joint_packets_and_jacobians', True),
}
...
def main():
    ...
    build = Path(tempfile.mkdtemp(prefix='abc-joint-packets-fresh-'))
    inventory = {}
    ...
    record.update(status='PASS: fresh scoped source compilation and complete axiom audit',
                  ...
                  not_claimed=['ABC proof or disproof', 'whole repository or Mathlib rebuild',
                               'actual modular phase-collision and signed-product separation constructions', 'finite-ring torsion or lifting',
