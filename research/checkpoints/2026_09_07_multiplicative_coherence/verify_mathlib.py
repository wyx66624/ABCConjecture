...
SOURCES = {
    ...
    'DeepRootPhaseArithmetic': ('2026_09_07_critical_bottleneck/twelfth_round', True),
    'ActualDeepRootCount': ('2026_09_07_multiplicative_coherence', True),
}
...
def main():
    ...
    build = Path(tempfile.mkdtemp(prefix='abc-multiplicative-coherence-fresh-'))
    inventory = {}
    ...
    record.update(status='PASS: fresh scoped source compilation and complete axiom audit',
                  ...
                  not_claimed=['ABC proof or disproof', 'whole repository or Mathlib rebuild',
                               'finite-ring torsion or lifting', 'arbitrary-root signed membership',
