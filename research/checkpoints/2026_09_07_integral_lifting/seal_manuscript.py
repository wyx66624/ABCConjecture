...
BUILD = ROOT / 'tmp/abc_20260907/round11pdf'
PREVIOUS_SHA = '599fd923441375391e3d2b6b301aebc7cc2a1093e975a8e7b87bfed4deba0a60'
...
def main():
    ...
    for relative, digest in build_sources.items():
        assert sha(ROOT / relative) == digest, relative
    prior = json.loads((ROOT / 'research/checkpoints/2026_09_07_depth_compensation/verification/manuscript_validation.json').read_text())
    ...
    assert unchanged_children == review['previous_unchanged_child_sources'] == 164
    ...
    assert formal['new_declarations'] == 31 and formal['dependency_declarations'] == 53
    assert len(formal['modules']) == 7
