...
SOURCES = {
    ...
    'ActualPrimeLogCompensation': ('2026_09_07_depth_compensation', False),
    'ActualPrimeLogHeight': ('2026_09_07_depth_compensation', False),
    'ActualGlobalSignedBridge': ('2026_09_07_critical_bottleneck/eleventh_round', True),
    'ActualProjectiveContent': ('2026_09_07_integral_lifting', True),
    'ResidualReflectionArithmetic': ('2026_09_07_integral_lifting', True),
    'ActualResidualLogThreshold': ('2026_09_07_integral_lifting', True),
}
...
def main():
    ...
    build = Path(tempfile.mkdtemp(prefix='abc-integral-lifting-fresh-'))
    inventory = {}
    ...
    record.update(status='PASS: fresh scoped source compilation and complete axiom audit',
                  ...
                  not_claimed=['ABC proof or disproof', 'whole repository or Mathlib rebuild',
                               'Eisenstein UFD', 'arbitrary-root signed membership',
                               'complete rational fiber-product inverse formalization'])
    save()
