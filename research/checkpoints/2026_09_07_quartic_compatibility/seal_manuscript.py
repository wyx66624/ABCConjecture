...
BUILD = ROOT / 'tmp/abc_20260907/round6pdf'
PREVIOUS_SHA = '5958c162f95cee3acac4a56ad82b10cf183ef5f498d2a020f01cab391ee83f0d'
...
def main():
    ...
    assert formal['status'].startswith('PASS:') and formal['new_theorems'] == 18
