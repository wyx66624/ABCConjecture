#!/usr/bin/env python3
"""Fresh, scoped Std-only compilation of actual Frey seed arithmetic."""
...
MODULES = {
    ...
    'FreySeedArithmetic': '2026_09_07_quartic_compatibility',
}
...
def main():
    ...
    build = Path(tempfile.mkdtemp(prefix='quartic-compatible-fresh-', dir=scratch))
    ...
    (build / 'lakefile.toml').write_text(
        'name = "ABCQuarticCompatibleAudit"\nversion = "0.1.0"\n'
        'defaultTargets = ["QuarticCompatibleAudit"]\n[leanOptions]\nwarningAsError = true\n'
        '[[lean_lib]]\nname = "QuarticCompatibleAudit"\nroots = [' + roots + ']\n')
    inventory = {}
    ...
    result = {
        ...
        'not_claimed': ['ABC proof or disproof', 'full repository build',
                        ...
                        'complete sixth-round formalization', 'Hensel or Faltings theorem', 'finite Kummer descent', 'Tate algorithm or modularity', 'external peer review'],
    }
