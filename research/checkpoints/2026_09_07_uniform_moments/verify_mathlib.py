...
SOURCES = {
    'PrivateValuationMultisets': ('2026_09_07_uniform_moments', True),
    'UniformMomentArithmetic': ('2026_09_07_critical_bottleneck/thirteenth_round', True),
    'ActualUniformDepthBudget': ('2026_09_07_uniform_moments', True),
    'CubicUnitLocalArithmetic': ('2026_09_07_independent_route/thirteenth_round', True),
}
...
def main():
    ...
    build = Path(tempfile.mkdtemp(prefix='abc-uniform-moments-fresh-'))
    inventory = {}
