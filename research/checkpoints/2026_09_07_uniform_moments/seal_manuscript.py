...
BUILD = ROOT / 'tmp/abc_20260907/round13pdf'
PREVIOUS_SHA = '78fa137947ea385f432d4e97394270d2064283b3a0062595544676057e02e024'
...
def main():
    ...
    for relative, digest in build_sources.items():
        assert sha(ROOT / relative) == digest, relative
    prior = json.loads((ROOT / 'research/checkpoints/2026_09_07_multiplicative_coherence/verification/manuscript_validation.json').read_text())
    ...
    assert unchanged_children == review['previous_unchanged_child_sources'] == 184
    ...
    assert formal['new_declarations'] == 37 and formal['dependency_declarations'] == 0
