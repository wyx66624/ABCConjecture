...
BUILD = ROOT / 'tmp/abc_20260907/round5pdf'
PREVIOUS_SHA = '56227205e730c0e47f47b3fdb24089c0b709f1c956ac14c97e3b6c575b03972f'
...
def main():
    ...
    assert formal['status'].startswith('PASS:') and formal['new_theorems'] == 21
