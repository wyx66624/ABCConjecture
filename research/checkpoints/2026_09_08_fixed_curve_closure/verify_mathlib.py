...
SOURCES = {
    'NonlinearPowerSelectors': ('2026_09_08_fixed_curve_closure', True),
}
...
def main():
    ...
    build = Path(tempfile.mkdtemp(prefix='abc-fixed-curve-selectors-fresh-'))
    inventory = {}
    ...
    record.update(status='PASS: fresh scoped source compilation and complete axiom audit',
                  ...
                  not_claimed=['ABC proof or disproof', 'whole repository or Mathlib rebuild',
                               'CRT, polynomial squarefree values, density or moving uniformity', 'p-adic closure or height normalization',
