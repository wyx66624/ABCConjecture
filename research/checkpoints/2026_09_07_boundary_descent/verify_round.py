#!/usr/bin/env python3
"""Fresh, scoped Std-only compilation of actual thirteen map arithmetic."""
...
MODULES = {
    ...
    'QuarticSupportArithmetic': '2026_09_07_cyclotomic_covers',
    'ThirteenMapArithmetic': '2026_09_07_boundary_descent',
    'SquareGapArithmetic': '2026_09_07_critical_bottleneck/seventh_round',
}
...
def main():
    ...
    build = Path(tempfile.mkdtemp(prefix='boundary-descent-fresh-', dir=scratch))
    ...
    (build / 'lakefile.toml').write_text(
        'name = "ABCBoundaryDescentAudit"\nversion = "0.1.0"\n'
        'defaultTargets = ["BoundaryDescentAudit"]\n[leanOptions]\nwarningAsError = true\n'
        '[[lean_lib]]\nname = "BoundaryDescentAudit"\nroots = [' + roots + ']\n')
    inventory = {}
    for name, checkpoint in MODULES.items():
        ...
        inventory[name] = {
            ...
            'new': name in {'ThirteenMapArithmetic', 'SquareGapArithmetic'},
        }
    ...
    result = {
        ...
        'not_claimed': ['ABC proof or disproof', 'full repository build',
                        ...
                        'complete seventh-round formalization', 'Hensel or Faltings theorem', 'finite Kummer descent', 'Tate algorithm or modularity', 'external peer review'],
    }
