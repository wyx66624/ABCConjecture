...
BUILD = ROOT / 'tmp/abc_20260907/round7pdf'
PREVIOUS_SHA = '5051635834876d5f27d1c4b38ae8a3409dac2644f1d11184e355c02784fa2077'
...
def main():
    ...
    assert formal['status'].startswith('PASS:') and formal['new_theorems'] == 23
