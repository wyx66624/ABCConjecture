...
BUILD = ROOT / 'tmp/abc_20260907/round2pdf'
PREVIOUS_SHA = '36ea6367ee76db063f3ed9e44a6c4537b815a1173aa60a7eb7785d79fbacecf1'
...
def main():
    ...
    assert formal['status'].startswith('PASS:') and formal['new_theorems'] == 13
