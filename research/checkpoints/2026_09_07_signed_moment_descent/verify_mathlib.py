...
SOURCES = {
    ...
    'UniformMomentArithmetic': ('2026_09_07_critical_bottleneck/thirteenth_round', False),
    'AdaptiveOwnerArithmetic': ('2026_09_07_critical_bottleneck/fourteenth_round', False),
    'SignedMomentArithmetic': ('2026_09_07_critical_bottleneck/fifteenth_round', True),
    'ActualGramRigidity': ('2026_09_07_signed_moment_descent', True),
    'ActualSignedProducts': ('2026_09_07_signed_moment_descent', True),
    'ActualSingleOwnerBridge': ('2026_09_07_signed_moment_descent', True),
    'GaussianDescentArithmetic': ('2026_09_07_independent_route/fifteenth_round', True),
}
...
def main():
    ...
    build = Path(tempfile.mkdtemp(prefix='abc-signed-moment-descent-fresh-'))
    inventory = {}
    ...
    record.update(status='PASS: fresh scoped source compilation and complete axiom audit',
                  ...
                  not_claimed=['ABC proof or disproof', 'whole repository or Mathlib rebuild',
                               'arithmetic private valuation construction', 'finite-ring torsion or lifting',
