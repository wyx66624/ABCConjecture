...
BUILD = ROOT / 'tmp/abc_20260907/round15pdf'
PREVIOUS_SHA = '86a0273b4cd06f877fbcfa19b2aaecb74749665200ad9cabfbdd64e62fe3b8a3'
...
def main():
    ...
    for relative, digest in build_sources.items():
        assert sha(ROOT / relative) == digest, relative
    prior = json.loads((ROOT / 'research/checkpoints/2026_09_07_adaptive_precision/verification/manuscript_validation.json').read_text())
    ...
    assert unchanged_children == review['previous_unchanged_child_sources'] == 196
    ...
    assert formal['new_declarations'] == 55 and formal['dependency_declarations'] == 56
    assert len(formal['modules']) == 8
