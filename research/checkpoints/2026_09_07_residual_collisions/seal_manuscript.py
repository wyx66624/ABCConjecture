...
BUILD = ROOT / 'tmp/abc_20260907/round3pdf'
PREVIOUS_SHA = 'd1f0c548e9fbae7216eb6618910ff87cdf47c8a3087248f8ff5ba26176f28aec'
...
def main():
    ...
    assert len(build_sources) > 50 and len(review['visually_reviewed_pages']) >= 18
    ...
    assert formal['status'].startswith('PASS:') and formal['new_theorems'] == 27
