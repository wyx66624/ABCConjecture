#!/usr/bin/env python3
"""Fresh, scoped Std-only compilation of actual residual collision identities."""
...
MODULES = {
    ...
    'BoundaryGcd': '2026_09_05_eisenstein_descent',
    'MovingSupport': '2026_09_06_moving_support',
    'ResidualCollisions': '2026_09_07_residual_collisions',
    'QuarticTwistArithmetic': '2026_09_07_residual_collisions',
}
...
def main():
    ...
    build = Path(tempfile.mkdtemp(prefix='residual-fresh-', dir=scratch))
    ...
    (build / 'lakefile.toml').write_text(
        'name = "ABCResidualCollisionAudit"\nversion = "0.1.0"\n'
        'defaultTargets = ["ResidualAudit"]\n[leanOptions]\nwarningAsError = true\n'
        '[[lean_lib]]\nname = "ResidualAudit"\nroots = [' + roots + ']\n')
    inventory = {}
    for name, checkpoint in MODULES.items():
        ...
        inventory[name] = {
            ...
            'new': name in {'ResidualCollisions', 'QuarticTwistArithmetic'},
        }
    ...
    result = {
        ...
        'not_claimed': ['ABC proof or disproof', 'full repository build',
                        ...
                        'complete third-round formalization', 'external peer review'],
    }
