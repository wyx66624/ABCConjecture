#!/usr/bin/env python3
"""Fresh standalone Lean 4.32.0 gate for actual primitive square-gap bounds."""
...
SOURCES = {
    ...
    'LocalPowerArithmetic': ROOT/'research/checkpoints/2026_09_07_support_power_classes/Lean/LocalPowerArithmetic.lean',
    'QuarticSupportArithmetic': ROOT/'research/checkpoints/2026_09_07_cyclotomic_covers/Lean/QuarticSupportArithmetic.lean',
    'SquareGapArithmetic': HERE/'Lean/SquareGapArithmetic.lean',
}
...
def main():
    ...
    build = Path(tempfile.mkdtemp(prefix='square-gap-fresh-', dir=scratch))
    ...
    (build/'lakefile.toml').write_text(
        'name = "SquareGapFreshAudit"\nversion = "0.1.0"\n'
        'defaultTargets = ["SquareGapFreshAudit"]\n[leanOptions]\nwarningAsError = true\n'
        '[[lean_lib]]\nname = "SquareGapFreshAudit"\nroots = ['+roots+']\n')
    inventory = {}
    ...
    result = {'status': 'PASS: fresh scoped Lake build and complete axiom inventory',
              ...
              'not_claimed': ['full repository build', 'ABC', 'full residue-sensitive constant r',
                              'class-thirteen elliptic descent', 'Brun-Titchmarsh',
                              'effective Diophantine exponent theorem']}
