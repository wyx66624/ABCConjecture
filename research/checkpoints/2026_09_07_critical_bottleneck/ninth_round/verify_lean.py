#!/usr/bin/env python3
"""Fresh Lean 4.32.0 audit of actual arms and the finite signed ledger."""
...
SOURCES = {
    ...
    'SignedArmArithmetic': HERE / 'Lean/SignedArmArithmetic.lean',
}
...
def main():
    ...
    build = Path(tempfile.mkdtemp(prefix='signed-arm-fresh-', dir=scratch))
    ...
    (build / 'lakefile.toml').write_bytes((
        'name = "SignedArmFreshAudit"\nversion = "0.1.0"\n'
        'defaultTargets = ["SignedArmFreshAudit"]\n[leanOptions]\nwarningAsError = true\n'
        '[[lean_lib]]\nname = "SignedArmFreshAudit"\nroots = [' + roots + ']\n').encode())
    inventory = {}
