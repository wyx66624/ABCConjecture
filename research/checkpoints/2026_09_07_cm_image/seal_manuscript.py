...
BUILD = ROOT / 'tmp/abc_20260907/round8pdf'
PREVIOUS_SHA = '5edc1ef137d8978e8c5cd8a73ed36343af6073da43f0bc795abfdfbaf134b0ef'
...
def main():
    ...
    assert formal['status'].startswith('PASS:') and formal['new_theorems'] == 10
