...
SOURCES = {
    ...
    'PrivateDensityMass': ('2026_09_07_adaptive_precision', True),
    'AdaptiveOwnerArithmetic': ('2026_09_07_critical_bottleneck/fourteenth_round', True),
    'SimultaneousEllipticArithmetic': ('2026_09_07_independent_route/fourteenth_round', True),
}
...
def main():
    ...
    build = Path(tempfile.mkdtemp(prefix='abc-adaptive-precision-fresh-'))
    inventory = {}
