...
BUILD = ROOT / 'tmp/abc_20260907/round9pdf'
PREVIOUS_SHA = '72027e59f91099aa8c3f7efad9643cfee0da72758c30d50b550fe081fcf6b79c'
...
def main():
    ...
    for relative, digest in build_sources.items():
        assert sha(ROOT / relative) == digest, relative
    prior = json.loads((ROOT / 'research/checkpoints/2026_09_07_cm_image/verification/manuscript_validation.json').read_text())
    ...
    assert unchanged_children == review['previous_unchanged_child_sources'] == 148
    ...
    assert formal['status'].startswith('PASS:') and formal['new_theorems'] == 54
