#!/usr/bin/env python3
"""Fresh, scoped Std-only compilation of signed-arm and common-exponent arithmetic."""
...
MODULES = {
    ...
    'GeneralLucasBoundary': '2026_09_07_cyclotomic_covers',
    'SignedArmArithmetic': '2026_09_07_critical_bottleneck/ninth_round',
    'CommonExponentArithmetic': '2026_09_07_independent_route/ninth_round',
    'ActualCommonExponentGap': '2026_09_07_independent_route/ninth_round',
    'ProgressionSupportArithmetic': '2026_09_07_signed_compatibility',
}
NEW_MODULES = {'SignedArmArithmetic', 'CommonExponentArithmetic',
               'ActualCommonExponentGap', 'ProgressionSupportArithmetic'}
...
def main():
    ...
    build = Path(tempfile.mkdtemp(prefix='signed-compatibility-fresh-', dir=scratch))
    ...
    (build / 'lakefile.toml').write_text(
        'name = "ABCSignedCompatibilityAudit"\nversion = "0.1.0"\n'
        'defaultTargets = ["SignedCompatibilityAudit"]\n[leanOptions]\nwarningAsError = true\n'
        '[[lean_lib]]\nname = "SignedCompatibilityAudit"\nroots = [' + roots + ']\n')
    inventory = {}
    ...
    result = {
        ...
        'not_claimed': ['ABC proof or disproof', 'full repository build',
                        'prime valuation allocation', 'real logarithmic estimates',
                        'signed-tail membership for arbitrary roots',
                        'complete ninth-round formalization', 'Eisenstein UFD',
                        'existence of simultaneous pure-power seeds', 'external peer review'],
    }
