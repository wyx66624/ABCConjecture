...
The complete orbit has zero linear average, but its oscillation and Euclidean
energy retain the Tate weight.  These scalar identities support the nonlinear,
Galois-invariant torsion-packet route.
-/

namespace IUTThreeClosures

/-- Difference between the canonical and noncanonical coefficients. -/
...
/-- Squared Euclidean norm of a vector with one canonical and `ell`
...
/-- Multiplication by a positive Tate weight preserves the ordering of the two
scores. -/
