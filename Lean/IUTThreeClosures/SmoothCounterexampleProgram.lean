...
Authors: ChatGPT
-/
import IUTThreeClosures.SmoothMainTermScaleAudit
...
This umbrella module collects the kernel-checked deterministic part of the
smooth-neighbour disproof route:
