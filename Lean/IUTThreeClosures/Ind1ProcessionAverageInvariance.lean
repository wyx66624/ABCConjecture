...
theorem capsuleAverage_transport
    ...
    (∑ j : (P.capsule i).LabelType,
      ...
      capsuleAverage value (A.capsulePerm i) := by
...
theorem sum_capsuleAverage_transport
    ...
    (∑ i : Fin P.length,
      ((∑ j : (P.capsule i).LabelType,
          value (A.capsulePerm i) (A.labelEquiv i j)) /
        (Fintype.card (P.capsule i).LabelType : ℝ))) =
      ∑ i : Fin P.length, capsuleAverage value i := by
  calc
    _ = ∑ i : Fin P.length,
        capsuleAverage value (A.capsulePerm i) := by
    ...
    _ = ∑ i : Fin P.length, capsuleAverage value i :=
...
theorem processionAverage_transport
    ...
    ((∑ i : Fin P.length,
      ((∑ j : (P.capsule i).LabelType,
        ...
        (Fintype.card (P.capsule i).LabelType : ℝ))) /
        (P.length : ℝ)) =
      ((∑ i : Fin P.length, capsuleAverage value i) /
        (P.length : ℝ)) := by
