...
PNT theorem parameter. The remaining hypotheses are arithmetic: the
exceptional-prime mass estimate, large-enough conditions, and the logarithmic
budget in the printed lemma.
-/
