...
-- their exact rational Weil heights, discriminant/conductor arithmetic, an
-- explicit fixed comparison curve, and preservation of perfect mod-ℓ image
-- after solvable base change.
