...
-- actual fixed-coefficient all-support transversality and exclusion remain
-- open arithmetic obligations.
...
-- from an explicit surface-boundary equality.  The inductive relation
-- generated by permitted rational five-term moves, and the two analytic
-- Gate VF estimates, remain open.
