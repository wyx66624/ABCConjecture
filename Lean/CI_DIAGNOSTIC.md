...
```text
✖ [8787/8822] Building IUTThreeClosures.PrimePowerGeneratedThetaHull (7.3s)
error: IUTThreeClosures/PrimePowerGeneratedThetaHull.lean:310:28: unsolved goals
...
z : (G.container.packet i (RationalPlace.finite p)).Total := fun d ↦ if h : d = c then ⋯ ▸ x c else 0
d : G.container.Components i (RationalPlace.finite p)
hdc : ¬d = c
⊢ ∀ (h : d = c), ⋯ ▸ x c = 0
warning: IUTThreeClosures/PrimePowerGeneratedThetaHull.lean:310:40: This simp argument is unused:
  hdc
...
error: Lean exited with code 1
⚠ [8789/8822] Built IUTThreeClosures.HonestContainerSource (7.0s)
...
⚠ [8791/8822] Built IUTThreeClosures.PublicLogVolumeInconsistency (4.6s)
warning: IUTThreeClosures/PublicLogVolumeInconsistency.lean:1:1: * '-/':
Copyright too short!


Note: This linter can be disabled with `set_option linter.style.header false`
✔ [8792/8822] Built IUTThreeClosures.ABCClosure (5.0s)
✔ [8793/8822] Built IUTThreeClosures.ThreeClosureTheorems (3.9s)
✔ [8794/8822] Built IUTThreeClosures.InhabitationBoundary (4.2s)
✔ [8795/8822] Built IUTThreeClosures.CircularityAudit (4.2s)
✔ [8796/8822] Built IUTThreeClosures.NonCircularDownstream (5.0s)
✔ [8797/8822] Built IUTThreeClosures.FourOpenConstructions (4.2s)
⚠ [8798/8822] Built IUTThreeClosures.ABCPointLegendreCurve (4.7s)
...
⚠ [8799/8822] Built IUTThreeClosures.BridgeInhabitationAudit (4.7s)
...
Note: This linter can be disabled with `set_option linter.unusedTactic false`
⚠ [8800/8822] Built IUTThreeClosures.PublicProgramUninhabited (5.5s)
warning: IUTThreeClosures/PublicProgramUninhabited.lean:1:1: * '-/':
Copyright too short!


Note: This linter can be disabled with `set_option linter.style.header false`
⚠ [8801/8822] Built IUTThreeClosures.LegendreArithmetic (6.1s)
warning: IUTThreeClosures/LegendreArithmetic.lean:1:1: * '-/':
Copyright too short!


Note: This linter can be disabled with `set_option linter.style.header false`
✔ [8802/8822] Built IUTThreeClosures.BridgeInhabitationExact (5.6s)
⚠ [8803/8822] Built IUTThreeClosures.TripodWeilHeight (4.7s)
...
Note: This linter can be disabled with `set_option linter.style.whitespace false`
⚠ [8804/8822] Built IUTThreeClosures.ABCFreyCurve (6.2s)
...
Note: This linter can be disabled with `set_option linter.unnecessarySeqFocus false`
⚠ [8805/8822] Built IUTThreeClosures.CanonicalQPilotCorridor (6.5s)
...
Note: This linter can be disabled with `set_option linter.style.whitespace false`
⚠ [8806/8822] Built IUTThreeClosures.LegendreHeightCorridor (7.2s)
warning: IUTThreeClosures/LegendreHeightCorridor.lean:1:1: * '-/':
Copyright too short!


Note: This linter can be disabled with `set_option linter.style.header false`
⚠ [8807/8822] Built IUTThreeClosures.ShiftedJAdmissibleCurve (7.5s)
warning: IUTThreeClosures/ShiftedJAdmissibleCurve.lean:1:1: * '-/':
Copyright too short!


Note: This linter can be disabled with `set_option linter.style.header false`
⚠ [8808/8822] Built IUTThreeClosures.FreyDiscriminantConductor (6.8s)
warning: IUTThreeClosures/FreyDiscriminantConductor.lean:1:1: * '-/':
Copyright too short!


Note: This linter can be disabled with `set_option linter.style.header false`
✔ [8809/8822] Built IUTThreeClosures.CanonicalCorridorAudit (6.2s)
⚠ [8810/8822] Built IUTThreeClosures.SourceDerivedIUTIVBridge (8.1s)
...
Note: This linter can be disabled with `set_option linter.style.whitespace false`
⚠ [8811/8822] Built IUTThreeClosures.FreyJReducedData (6.5s)
warning: IUTThreeClosures/FreyJReducedData.lean:1:1: * '-/':
Copyright too short!


Note: This linter can be disabled with `set_option linter.style.header false`
⚠ [8812/8822] Built IUTThreeClosures.DifferentSupportAbsorption (6.6s)
...
⚠ [8813/8822] Built IUTThreeClosures.FreyJHeightCorridor (5.2s)
warning: IUTThreeClosures/FreyJHeightCorridor.lean:1:1: * '-/':
Copyright too short!


Note: This linter can be disabled with `set_option linter.style.header false`
⚠ [8814/8822] Built IUTThreeClosures.GlobalQPilotReconstruction (5.3s)
warning: IUTThreeClosures/GlobalQPilotReconstruction.lean:1:1: * '-/':
Copyright too short!


Note: This linter can be disabled with `set_option linter.style.header false`
⚠ [8815/8822] Built IUTThreeClosures.FreyCalibratedIUTIVBridge (5.5s)
...
Note: This linter can be disabled with `set_option linter.unusedVariables false`
⚠ [8816/8822] Built IUTThreeClosures.CompleteGlobalJPacket (5.0s)
warning: IUTThreeClosures/CompleteGlobalJPacket.lean:1:1: * '-/':
Copyright too short!


Note: This linter can be disabled with `set_option linter.style.header false`
⚠ [8817/8822] Built IUTThreeClosures.FreyConductorCalibratedIUTIVBridge (6.2s)
warning: IUTThreeClosures/FreyConductorCalibratedIUTIVBridge.lean:1:1: * '-/':
Copyright too short!


Note: This linter can be disabled with `set_option linter.style.header false`
⚠ [8818/8822] Built IUTThreeClosures.SelectedBadPlaceGlobalReconstruction (6.6s)
warning: IUTThreeClosures/SelectedBadPlaceGlobalReconstruction.lean:1:1: * '-/':
Copyright too short!


Note: This linter can be disabled with `set_option linter.style.header false`
✔ [8819/8822] Built IUTThreeClosures.PublicFreyTheorem110Bridge (7.1s)
✔ [8820/8822] Built IUTThreeClosures.PublicFreyComponentBridge (7.5s)
