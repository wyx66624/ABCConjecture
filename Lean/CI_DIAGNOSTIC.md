...
```text
✖ [8788/8822] Building IUTThreeClosures.PrimePowerGeneratedThetaHull (8.7s)
...
Note: This linter can be disabled with `set_option linter.unnecessarySimpa false`
✔ [8781/8822] Built IUTThreeClosures.ActualPilotWitness (4.3s)
⚠ [8782/8822] Built IUTThreeClosures.ExactRootNormalization (5.5s)
warning: IUTThreeClosures/ExactRootNormalization.lean:1:1: * '-/':
Copyright too short!


Note: This linter can be disabled with `set_option linter.style.header false`
✔ [8783/8822] Built IUTThreeClosures.PublicThetaHullComponentFormula (5.7s)
✔ [8784/8822] Built IUTThreeClosures.GeneratedSource (4.8s)
✔ [8785/8822] Built IUTThreeClosures.PublicThetaHullUpperBound (4.6s)
✔ [8786/8822] Built IUTThreeClosures.QuantifierCorrectClosure (5.7s)
⚠ [8787/8822] Built IUTThreeClosures.HonestContainerSource (5.0s)
...
⚠ [8791/8822] Built IUTThreeClosures.PublicLogVolumeInconsistency (6.7s)
warning: IUTThreeClosures/PublicLogVolumeInconsistency.lean:1:1: * '-/':
Copyright too short!


Note: This linter can be disabled with `set_option linter.style.header false`
✔ [8792/8822] Built IUTThreeClosures.ABCClosure (6.5s)
✔ [8793/8822] Built IUTThreeClosures.ThreeClosureTheorems (3.8s)
✔ [8794/8822] Built IUTThreeClosures.InhabitationBoundary (3.9s)
✔ [8795/8822] Built IUTThreeClosures.CircularityAudit (3.0s)
...
Note: This linter can be disabled with `set_option linter.unusedTactic false`
⚠ [8800/8822] Built IUTThreeClosures.PublicProgramUninhabited (5.8s)
...
Note: This linter can be disabled with `set_option linter.style.header false`
✔ [8802/8822] Built IUTThreeClosures.BridgeInhabitationExact (5.4s)
⚠ [8803/8822] Built IUTThreeClosures.ABCFreyCurve (5.1s)
...
Note: This linter can be disabled with `set_option linter.unnecessarySeqFocus false`
⚠ [8804/8822] Built IUTThreeClosures.TripodWeilHeight (5.6s)
...
Note: This linter can be disabled with `set_option linter.style.whitespace false`
⚠ [8805/8822] Built IUTThreeClosures.CanonicalQPilotCorridor (6.1s)
...
Note: This linter can be disabled with `set_option linter.style.whitespace false`
⚠ [8806/8822] Built IUTThreeClosures.LegendreHeightCorridor (6.4s)
warning: IUTThreeClosures/LegendreHeightCorridor.lean:1:1: * '-/':
Copyright too short!


Note: This linter can be disabled with `set_option linter.style.header false`
⚠ [8807/8822] Built IUTThreeClosures.FreyDiscriminantConductor (7.1s)
warning: IUTThreeClosures/FreyDiscriminantConductor.lean:1:1: * '-/':
Copyright too short!


Note: This linter can be disabled with `set_option linter.style.header false`
⚠ [8808/8822] Built IUTThreeClosures.ShiftedJAdmissibleCurve (7.1s)
warning: IUTThreeClosures/ShiftedJAdmissibleCurve.lean:1:1: * '-/':
Copyright too short!


Note: This linter can be disabled with `set_option linter.style.header false`
⚠ [8809/8822] Built IUTThreeClosures.SourceDerivedIUTIVBridge (7.4s)
...
Note: This linter can be disabled with `set_option linter.style.whitespace false`
✔ [8810/8822] Built IUTThreeClosures.CanonicalCorridorAudit (5.7s)
⚠ [8811/8822] Built IUTThreeClosures.FreyJReducedData (6.2s)
warning: IUTThreeClosures/FreyJReducedData.lean:1:1: * '-/':
Copyright too short!


Note: This linter can be disabled with `set_option linter.style.header false`
⚠ [8812/8822] Built IUTThreeClosures.DifferentSupportAbsorption (6.3s)
...
⚠ [8813/8822] Built IUTThreeClosures.FreyJHeightCorridor (4.7s)
warning: IUTThreeClosures/FreyJHeightCorridor.lean:1:1: * '-/':
Copyright too short!


Note: This linter can be disabled with `set_option linter.style.header false`
⚠ [8814/8822] Built IUTThreeClosures.GlobalQPilotReconstruction (4.4s)
warning: IUTThreeClosures/GlobalQPilotReconstruction.lean:1:1: * '-/':
Copyright too short!


Note: This linter can be disabled with `set_option linter.style.header false`
⚠ [8815/8822] Built IUTThreeClosures.CompleteGlobalJPacket (5.4s)
warning: IUTThreeClosures/CompleteGlobalJPacket.lean:1:1: * '-/':
Copyright too short!


Note: This linter can be disabled with `set_option linter.style.header false`
⚠ [8816/8822] Built IUTThreeClosures.FreyCalibratedIUTIVBridge (5.6s)
...
Note: This linter can be disabled with `set_option linter.style.header false`
⚠ [8818/8822] Built IUTThreeClosures.SelectedBadPlaceGlobalReconstruction (6.4s)
