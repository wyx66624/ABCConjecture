...
```text
✖ [8787/8822] Building IUTThreeClosures.PrimePowerGeneratedThetaHull (7.8s)
...
error: Lean exited with code 1
⚠ [8788/8822] Built IUTThreeClosures.HonestContainerSource (8.1s)
...
⚠ [8791/8822] Built IUTThreeClosures.PublicLogVolumeInconsistency (5.1s)
warning: IUTThreeClosures/PublicLogVolumeInconsistency.lean:1:1: * '-/':
Copyright too short!


Note: This linter can be disabled with `set_option linter.style.header false`
✔ [8792/8822] Built IUTThreeClosures.ABCClosure (4.3s)
✔ [8793/8822] Built IUTThreeClosures.ThreeClosureTheorems (3.6s)
✔ [8794/8822] Built IUTThreeClosures.InhabitationBoundary (3.7s)
✔ [8795/8822] Built IUTThreeClosures.CircularityAudit (3.8s)
✔ [8796/8822] Built IUTThreeClosures.NonCircularDownstream (4.7s)
✔ [8797/8822] Built IUTThreeClosures.FourOpenConstructions (3.9s)
⚠ [8798/8822] Built IUTThreeClosures.ABCPointLegendreCurve (4.2s)
...
Note: This linter can be disabled with `set_option linter.style.header false`
⚠ [8800/8822] Built IUTThreeClosures.BridgeInhabitationAudit (5.8s)
...
Note: This linter can be disabled with `set_option linter.unusedTactic false`
⚠ [8801/8822] Built IUTThreeClosures.LegendreArithmetic (5.7s)
...
⚠ [8803/8822] Built IUTThreeClosures.TripodWeilHeight (5.5s)
...
Note: This linter can be disabled with `set_option linter.style.whitespace false`
⚠ [8806/8822] Built IUTThreeClosures.LegendreHeightCorridor (6.8s)
warning: IUTThreeClosures/LegendreHeightCorridor.lean:1:1: * '-/':
Copyright too short!


Note: This linter can be disabled with `set_option linter.style.header false`
⚠ [8807/8822] Built IUTThreeClosures.FreyDiscriminantConductor (6.6s)
...
Note: This linter can be disabled with `set_option linter.style.header false`
⚠ [8809/8822] Built IUTThreeClosures.SourceDerivedIUTIVBridge (7.8s)
...
⚠ [8811/8822] Built IUTThreeClosures.FreyJReducedData (6.0s)
warning: IUTThreeClosures/FreyJReducedData.lean:1:1: * '-/':
Copyright too short!


Note: This linter can be disabled with `set_option linter.style.header false`
⚠ [8812/8822] Built IUTThreeClosures.DifferentSupportAbsorption (6.5s)
...
Note: This linter can be disabled with `set_option linter.style.header false`
⚠ [8814/8822] Built IUTThreeClosures.GlobalQPilotReconstruction (4.2s)
warning: IUTThreeClosures/GlobalQPilotReconstruction.lean:1:1: * '-/':
Copyright too short!


Note: This linter can be disabled with `set_option linter.style.header false`
⚠ [8815/8822] Built IUTThreeClosures.CompleteGlobalJPacket (5.3s)
warning: IUTThreeClosures/CompleteGlobalJPacket.lean:1:1: * '-/':
Copyright too short!


Note: This linter can be disabled with `set_option linter.style.header false`
⚠ [8816/8822] Built IUTThreeClosures.FreyCalibratedIUTIVBridge (5.5s)
...
Note: This linter can be disabled with `set_option linter.unusedVariables false`
⚠ [8817/8822] Built IUTThreeClosures.FreyConductorCalibratedIUTIVBridge (6.0s)
warning: IUTThreeClosures/FreyConductorCalibratedIUTIVBridge.lean:1:1: * '-/':
Copyright too short!


Note: This linter can be disabled with `set_option linter.style.header false`
⚠ [8818/8822] Built IUTThreeClosures.SelectedBadPlaceGlobalReconstruction (6.3s)
