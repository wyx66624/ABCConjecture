...
hull or Ind3 comparison. We also prove effective finiteness of a specified
...
endpoint and denominator costs. No priority over existing literature is
...
surjectivity forcing a unit scalar.\\
\bottomrule
\end{longtable}
...
growing omitted endpoint or denominators uniformly; the local IUT route
still needs the actual Ind1 image and the subsequent Ind3/global
comparison. Eliminating Ind2 from one fixed $B$-module hull does not
eliminate those tasks. No unconditional closed term
