#!/usr/bin/env python3
"""Reproduce the selection/volume/Pell/block-mass checkpoint.
...
MODULES = (
    "AffineCommonKernelTripleSelection20260901",
    "IUTAdmissibleVolumeIntegerBridge20260901",
    "MersenneFixedPolylogBlockMassTriage20260901",
    "PellResidueParityLocalization20260901",
)
MODULE_PATHS = tuple(
...
EXTRA_INPUT_PATHS = (
    ...
    "paper/affine_common_kernel_triple_selection_2026.tex",
    "paper/iut_admissible_volume_integer_bridge_2026.tex",
    "paper/mersenne_fixed_polylog_block_mass_triage_2026.tex",
    "paper/pell_residue_parity_localization_2026.tex",
    "research/computation/2026_09_01_mersenne_super_wieferich_depth/scan_10m.json",
    "research/computation/2026_09_01_mersenne_super_wieferich_depth/verify_super_wieferich.py",
    "research/computation/2026_09_01_mersenne_super_wieferich_depth/verification.json",
    "research/computation/2026_09_01_mersenne_super_wieferich_depth/SHA256SUMS",
    "output/pdf/ChatGPT_ABC_Uniformity_2026.pdf",
)
EXPECTED_AGGREGATE_JOBS = 9220
...
def validate(record: bool) -> None:
    ...
    inventory_document = {
        "schema": "abc-selection-volume-pell-block-mass-inventory-v1",
        "modules": inventories,
        "totals": {
            **totals,
    ...
    result = {
        "schema": "abc-selection-volume-pell-block-mass-validation-v1",
        "status": "PASS",
...
def verify_recorded_structure() -> dict[str, Any]:
    ...
    if result.get("schema") != "abc-selection-volume-pell-block-mass-validation-v1":
