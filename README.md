...
> [!IMPORTANT]
> **Global status as of September 8, 2026:** this repository does **not**
...
| [`research/checkpoints/2026_09_08_descent_and_shift/README.md`](research/checkpoints/2026_09_08_descent_and_shift/README.md) | Current continuation: complete squared-unit descent, actual square/cube and ramified exclusions, shifted boundaries and all-owner paired bounds; 15 new finite arithmetic Lean theorems |
| [`research/checkpoints/2026_09_08_fixed_curve_closure/README.md`](research/checkpoints/2026_09_08_fixed_curve_closure/README.md) | Previous fixed six-point rational locus, actual cubic boundary and nonlinear selectors; 24 new scoped Lean theorems |
| [`research/checkpoints/2026_09_07_collective_content_closure/README.md`](research/checkpoints/2026_09_07_collective_content_closure/README.md) | Earlier collective content, fixed-data affine compensation, local height target and radical-partition barriers |
| [`output/pdf/ChatGPT_ABC_Uniformity_2026_08_31.pdf`](output/pdf/ChatGPT_ABC_Uniformity_2026_08_31.pdf) | Current 621-page integrated manuscript, maintained at the user-designated filename; the filename is historical |
...
| [`research/checkpoints/2026_09_07_uniform_moments/README.md`](research/checkpoints/2026_09_07_uniform_moments/README.md) | Thirteenth continuation: uniform moments, colored norm support and cubic local/elliptic gates; 37 new scoped Lean declarations |
| [`research/checkpoints/2026_09_07_multiplicative_coherence/README.md`](research/checkpoints/2026_09_07_multiplicative_coherence/README.md) | Twelfth continuation: actual multiplicative coherence, private norm support, exact phase fibers and rational quotient curves; 21 new scoped Lean declarations |
| [`research/checkpoints/2026_09_07_integral_lifting/README.md`](research/checkpoints/2026_09_07_integral_lifting/README.md) | Eleventh continuation: actual content, residual reflection, integral inverse gates, global signed radical, squarefree windows and simultaneous quadratic-domain covers; 31 new scoped Lean declarations |
| [`research/checkpoints/2026_09_07_depth_compensation/README.md`](research/checkpoints/2026_09_07_depth_compensation/README.md) | Tenth continuation: actual prime logarithms, reciprocal-depth compensation, three-arm counterfamilies, elementary block inputs, double oriented covers and rational descent; 41 new scoped Lean declarations |
| [`research/checkpoints/2026_09_07_signed_compatibility/README.md`](research/checkpoints/2026_09_07_signed_compatibility/README.md) | Ninth continuation: actual signed-arm compensation, prime-power and totient progression support, full-exponent root growth, and 54 new scoped Lean declarations |
| [`research/checkpoints/2026_09_07_cm_image/README.md`](research/checkpoints/2026_09_07_cm_image/README.md) | Eighth continuation: CM elimination, full-Sturm boundary twists, two-torsion support, all-index windows, and 10 new scoped Lean declarations |
| [`research/checkpoints/2026_09_07_boundary_descent/README.md`](research/checkpoints/2026_09_07_boundary_descent/README.md) | Seventh continuation: boundary modular identification, complete ordinary thirteen-square descent, effective affine escape, and 23 new scoped Lean declarations |
| [`research/checkpoints/2026_09_07_quartic_compatibility/README.md`](research/checkpoints/2026_09_07_quartic_compatibility/README.md) | Sixth continuation: actual root intervals, compatible quartic covers, Frey modular budgets, and 18 new scoped Lean declarations |
| [`research/checkpoints/2026_09_07_cyclotomic_covers/README.md`](research/checkpoints/2026_09_07_cyclotomic_covers/README.md) | Fifth continuation: actual cyclotomic packets, maximal-rank depth boundaries, quantitative covers, and 21 new scoped Lean declarations |
| [`research/checkpoints/2026_09_07_support_power_classes/README.md`](research/checkpoints/2026_09_07_support_power_classes/README.md) | Fourth continuation: signed support entropy, finite higher-power descent, actual extraction families, and 15 new scoped Lean declarations |
...
The current continuation completes an ordinary rank-zero two-descent for the
squared-unit cubic quotient and excludes the actual primitive square/cube
intersection. A separate ramified argument proves that a cube second norm
forces the first norm to be prime to three. Shifted resultants and an
all-owner theorem control specified paired depths on original blocks.
The seven ordinary sources, fifteen new finite arithmetic Lean theorems,
and two exact replays have distinct scopes. The earlier fixed six-point
rational locus is also complete in ordinary mathematics. Unmatched
cross-prime tails, moving-data transfer, uniform varying-family heights
and arbitrary ABC coverage remain open. See the current checkpoint for
the full proofs, verification evidence and precise remaining gaps.
